            ...
            8: [
                function (d, r, q) {
                            ...
                            },
                            {
                                ...
                                value: function (b, a) {
                                    return {
                                        ...
                                        format: {
                                            grouping_identity: b.isBitSetAt(
                                                a + 1,
                                                7
                                            ),
                                            compression: b.isBitSetAt(a + 1, 3),
                                            encryption: b.isBitSetAt(a + 1, 2),
                                            unsynchronisation: b.isBitSetAt(
                                                a + 1,
                                                1
                                            ),
                                            data_length_indicator: b.isBitSetAt(
                                                a + 1,
                                                0
                                            ),
                                        },
                    ...
                    var l = {
                        APIC: function (b, f, a, c, k) {
                            ...
                            switch (k && k.major) {
                                ...
                                default:
                                    throw Error(
                                        "Couldn't read ID3v2 major version."
                                    );
                            }
                            var e = a.getByteAt(b);
                            e = t[e];
                            g = a.getStringWithCharsetAt(
                                b + 1,
                                f - (b - c) - 1,
                                g
                            );
                    ...
                    l['T*'] = function (b, f, a, c, k) {
                        c = v(a.getByteAt(b));
                        return a
                            .getStringWithCharsetAt(b + 1, f - 1, c)
                            .toString();
                    };
                    ...
                    l['W*'] = function (b, f, a, c, k) {
                        return 0 === f
                            ? null
                            : a
                                  .getStringWithCharsetAt(b, f, 'iso-8859-1')
                                  .toString();
                    };
                        ...
                        v(
                            ...
                            [
                                ...
                                },
                                {
                                    ...
                                    value: function (a) {
                                        var b = this,
                                            c = this._roundRangeToChunkMultiple(
                                                [0, 0]
                                            );
                                ...
                                },
                                {
                                    ...
                                    value: function (a) {
                                        if (
                                            ...
                                            return {
                                                firstBytePosition: parseInt(
                                                    b[1],
                                                    10
                                                ),
                                                lastBytePosition: parseInt(
                                                    b[2],
                                                    10
                                                ),
                                                instanceLength: b[3]
                                ...
                                },
                                {
                                    ...
                                    value: function (a, b) {
                                        var c = this;
                                        c._fileData.hasDataRange(
                                            a[0],
                                            Math.min(c._size, a[1])
                                        )
                                            ? setTimeout(b.onSuccess, 1)
                                            : ((a =
                                                  this._roundRangeToChunkMultiple(
                                                      a
                                                  )),
                                ...
                                },
                                {
                                    ...
                                    value: function (a, b, d) {
                                        0 >
                                            c._config.disallowedXhrHeaders.indexOf(
                                                b.toLowerCase()
            ...
            15: [
                function (d, r, q) {
                    ...
                    function e(a, b) {
                        var c =
                            0 > a.offset &&
                            (-a.offset > b || 0 < a.offset + a.length);
                        return !(
                            (0 <= a.offset && a.offset + a.length >= b) ||
                            c
                        );
                    }
                    d('./MediaFileReader');
